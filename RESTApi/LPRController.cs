...
{
    public class LPRController : ApiController
    {
        // GET: api/LPR
        [Route("api/LPR/{guid}/{reg}")]
        [HttpGet]
    ...
    */
        ...
        // POST: api/LPR
        [Route("api/LPR/{guid}/{recognizeVehicle}")]
        [HttpPost]
        ...
        // POST: api/LPR
        [Route("api/LPR/{guid}/{recognizeVehicle}/{tablica}")]
        [HttpPost]
