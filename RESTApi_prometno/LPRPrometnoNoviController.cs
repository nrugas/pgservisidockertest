...
{
    public class LPRPrometnoNoviController : ApiController
    {
        // GET: api/LPR
        [Route("Prometno/api/LPRNovi/{guid}/{reg}")]
        [HttpGet]
        ...
        // GET: api/LPR
        [Route("Prometno/api/LPRNovi/{guid}/{reg}/{drz}")]
        [HttpGet]
    ...
    */
        ...
        // POST: api/LPR
        [Route("Prometno/api/LPRNovi/{guid}")]
        [HttpPost]
        public JObject Post(string guid, [FromBody]string value)
        {
        ...
        // POST: api/LPR
        [Route("Prometno/api/LPRNovi/{guid}/{recognizeVehicle}")]
        [HttpPost]
        ...
        // POST: api/LPR
        [Route("Prometno/api/LPRNovi/{guid}/{recognizeVehicle}/{tablica}")]
        [HttpPost]
